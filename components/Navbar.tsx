    ...
    <nav className="fixed top-0 left-0 right-0 z-50 px-6 py-4">
      <div className="max-w-7xl mx-auto flex items-center justify-between glass-morphism rounded-full px-8 py-3 shadow-sm border border-white/50">
        ...
        <div className="hidden md:flex items-center gap-8 text-sm font-semibold text-slate-600">
          <a href="#zespol" className="hover:text-emerald-600 transition-colors">Zespół</a>
          <a href="#services" className="hover:text-emerald-600 transition-colors">Usługi</a>
          <a href="#ai-assistant" className="hover:text-emerald-600 transition-colors">Sprawdź Objawy</a>
